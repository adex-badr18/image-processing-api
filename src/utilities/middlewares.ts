...
export const getFullImage = async (
  ...
  let fullImageArray: { image: string; imagePath: string }[] =
    imageCache.get('fullImageArray')!;
  const resizedImage: string[] = imageCache.get('resizedImage')! || ['', ''];
...
export const getThumbImage = async (
  ...
  let thumbImageArray: { image: string; imagePath: string }[] =
    imageCache.get('thumbImageArray')!;
  if (!thumbImageArray) {
